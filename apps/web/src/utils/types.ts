...
export const moduleRegistry: Record<ModuleKey, ModuleMeta> = {
  ...
  adDiagnostics: {
    ...
    description: 'Reach duplication, new-to-brand mix, creative fatigue, matched-geo stability, and the descriptive diagnostics serious media teams run before lift claims.',
    category: 'applied',
    ...
    estimatedMinutes: 24,
    learningObjectives: [
      'Diagnose reach efficiency, acquisition mix, and fatigue before moving into formal lift work.',
      'Explain why blended campaign numbers can hide duplication, mix shifts, and unstable geo baselines.',
      'Use distributions, medians, IQRs, and segment decomposition the way measurement teams actually report them.',
    ],
  },
  adExperiments: {
  ...
  adRegression: {
    ...
    description: 'Naive versus adjusted spend-response models, confounding demand or promo effects, and coefficient interpretation that resembles real MMM and planning work.',
    category: 'applied',
    ...
    estimatedMinutes: 26,
    learningObjectives: [
      'Interpret adjusted coefficients, fitted values, and residuals in marketing planning contexts.',
      'Explain how omitted variables like demand or promotions distort naive advertising regressions.',
      'Communicate why better-controlled models improve planning without magically becoming pure incrementality proof.',
    ],
  },
}
