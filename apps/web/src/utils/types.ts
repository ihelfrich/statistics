...
export const moduleRegistry: Record<ModuleKey, ModuleMeta> = {
  ...
  adDiagnostics: {
    ...
    kicker: 'Audit measurement quality',
    description: 'Reach duplication, acquisition mix, creative fatigue, and geo-test readiness framed as operational diagnostics that determine whether later lift claims will stand up.',
    category: 'applied',
    ...
    estimatedMinutes: 27,
    learningObjectives: [
      'Diagnose reach efficiency, acquisition mix, fatigue, and geo readiness before anyone talks about incrementality.',
      'Explain why blended campaign numbers can hide duplication, mix shifts, tail weakness, and unstable geo baselines.',
      'Use distributions, medians, IQRs, and segment decomposition to produce decision-ready measurement diagnostics.',
    ],
  },
  adExperiments: {
  ...
  adRegression: {
    ...
    kicker: 'Model with controls',
    description: 'Naive versus adjusted spend-response models, confounding demand or promo effects, and planning readouts that keep fit, forecast, and causality in the right boxes.',
    category: 'applied',
    ...
    estimatedMinutes: 30,
    learningObjectives: [
      'Interpret adjusted coefficients, fitted values, and residuals in realistic advertising planning contexts.',
      'Explain how omitted variables like demand or promotions distort naive advertising regressions.',
      'Communicate why better-controlled models improve planning without pretending to become pure incrementality proof.',
    ],
  },
}
